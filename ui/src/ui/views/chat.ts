          ...
          ? html`
              <div class="chat-empty-state">
                ...
                <div class="chat-empty-state__body">
                  No conversation yet in this tab. Type a message below or create a new position.
                </div>
              </div>
            `
          : nothing
        ...
        <div class="chat-compose__row">
          ...
          <div class="chat-compose__actions">
            <button
              ...
              @click=${canAbort ? props.onAbort : (props.onAddPosition ?? props.onNewSession)}
            >
              ${canAbort ? "Stop" : "New position"}
            </button>
            <button
              class="btn primary"
              ?disabled=${!props.connected}
